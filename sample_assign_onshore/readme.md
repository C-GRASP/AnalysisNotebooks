...
### To do so we use 2 United States shapefiles from Natural Earth data (https://www.naturalearthdata.com/) of 10 and 50m resolution. With these two shapefiles, two new datasets are created of samples within each respective polygon. Any samples outside of either polygon resolution, of 10 to 50m are estimated as offshore. 
